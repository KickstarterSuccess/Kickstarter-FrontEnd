...
function App(props) {
  ...
  // useEffect(() => {
  //   fetch('https://kickstarter-success-ft.herokuapp.com/test').then(res => res.json()).then(data => {
  //     setResults(data);
  //   });
  // }, []);
  ...
  useEffect(() => {
    axios.get('https://kickstarter-success-ft.herokuapp.com/test').then(res => res.json()).then(data => {
      setResults(data);
    })
}, []);
  ...
  const formSchema = yup.object().shape({
    ...
    const formSubmit = e => {
      ...
      axios
      // .post(formState)
      .post("https://kickstarter-success-ft.herokuapp.com/test", formState)
        .then(res => {
          setPost(res.data); // get just the form data from the REST api
          console.log("success", post);
          console.log(res)
